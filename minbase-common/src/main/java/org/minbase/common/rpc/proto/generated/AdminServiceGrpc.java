...
public class AdminServiceGrpc {
  ...
  @io.grpc.ExperimentalApi
  public static final io.grpc.MethodDescriptor<AdminProto.AddColumnRequest,
      AdminProto.AddColumnResponse> METHOD_ADD_COLUMN =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "org.minbase.common.rpc.proto.generated.AdminService", "addColumn"),
          io.grpc.protobuf.ProtoUtils.marshaller(AdminProto.AddColumnRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(AdminProto.AddColumnResponse.getDefaultInstance()));
  @io.grpc.ExperimentalApi
  public static final io.grpc.MethodDescriptor<AdminProto.GetTableInfoRequest,
      AdminProto.GetTableInfoResponse> METHOD_GET_TABLE_INFO =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "org.minbase.common.rpc.proto.generated.AdminService", "getTableInfo"),
          io.grpc.protobuf.ProtoUtils.marshaller(AdminProto.GetTableInfoRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(AdminProto.GetTableInfoResponse.getDefaultInstance()));
  ...
  public static interface AdminService {
    ...
    public void addColumn(AdminProto.AddColumnRequest request,
                          io.grpc.stub.StreamObserver<AdminProto.AddColumnResponse> responseObserver);

    public void getTableInfo(AdminProto.GetTableInfoRequest request,
                             io.grpc.stub.StreamObserver<AdminProto.GetTableInfoResponse> responseObserver);
  }
  ...
  public static interface AdminServiceFutureClient {
    ...
    public com.google.common.util.concurrent.ListenableFuture<AdminProto.AddColumnResponse> addColumn(
        AdminProto.AddColumnRequest request);

    public com.google.common.util.concurrent.ListenableFuture<AdminProto.GetTableInfoResponse> getTableInfo(
        AdminProto.GetTableInfoRequest request);
  }
  ...
  public static class AdminServiceStub extends io.grpc.stub.AbstractStub<AdminServiceStub>
    ...
    public void addColumn(AdminProto.AddColumnRequest request,
                          io.grpc.stub.StreamObserver<AdminProto.AddColumnResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_ADD_COLUMN, getCallOptions()), request, responseObserver);
    }
    ...
    public void getTableInfo(AdminProto.GetTableInfoRequest request,
                             io.grpc.stub.StreamObserver<AdminProto.GetTableInfoResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_GET_TABLE_INFO, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static class AdminServiceBlockingStub extends io.grpc.stub.AbstractStub<AdminServiceBlockingStub>
    ...
    public AdminProto.AddColumnResponse addColumn(AdminProto.AddColumnRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_ADD_COLUMN, getCallOptions(), request);
    }

    @Override
    public AdminProto.GetTableInfoResponse getTableInfo(AdminProto.GetTableInfoRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_GET_TABLE_INFO, getCallOptions(), request);
    }
  }
  ...
  public static class AdminServiceFutureStub extends io.grpc.stub.AbstractStub<AdminServiceFutureStub>
    ...
    public com.google.common.util.concurrent.ListenableFuture<AdminProto.AddColumnResponse> addColumn(
        AdminProto.AddColumnRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_ADD_COLUMN, getCallOptions()), request);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<AdminProto.GetTableInfoResponse> getTableInfo(
        AdminProto.GetTableInfoRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_GET_TABLE_INFO, getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_ADD_COLUMN = 3;
  private static final int METHODID_GET_TABLE_INFO = 4;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_ADD_COLUMN:
          serviceImpl.addColumn((AdminProto.AddColumnRequest) request,
              (io.grpc.stub.StreamObserver<AdminProto.AddColumnResponse>) responseObserver);
          break;
        case METHODID_GET_TABLE_INFO:
          serviceImpl.getTableInfo((AdminProto.GetTableInfoRequest) request,
              (io.grpc.stub.StreamObserver<AdminProto.GetTableInfoResponse>) responseObserver);
          break;
        default:
  ...
  public static io.grpc.ServerServiceDefinition bindService(
    ...
    return io.grpc.ServerServiceDefinition.builder(SERVICE_NAME)
        ...
        .addMethod(
          ...
          asyncUnaryCall(
            new MethodHandlers<
              AdminProto.AddColumnRequest,
              AdminProto.AddColumnResponse>(
                serviceImpl, METHODID_ADD_COLUMN)))
        .addMethod(
          METHOD_GET_TABLE_INFO,
          asyncUnaryCall(
            new MethodHandlers<
              AdminProto.GetTableInfoRequest,
              AdminProto.GetTableInfoResponse>(
                serviceImpl, METHODID_GET_TABLE_INFO)))
        .build();
  }
}
