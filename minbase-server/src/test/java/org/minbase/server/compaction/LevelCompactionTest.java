...
////        }
//        levelStorageManager = new LevelStoreManager(null);
//        //initDataFile();
//    }
//
//
...
//            levelStorageManager.addStoreFile(storeFile, sequence);
...
//        final StoreFile storeFile = levelStorageManager.loadStoreFiles("0e15dd05-f472-4e49-8a64-dcd681fa71e9");
//        final StoreFileIterator iterator = storeFile.getReader().iterator();
...
//
//
//        final StoreFileIterator iterator1 = storeFile.getReader().iterator();
...
//        final StoreFileIterator iterator2 = storeFile2.getReader().iterator();
//        while (iterator2.isValid()){
//            System.out.println(iterator2.value());
//            iterator2.next();
//        }
//
//        final StoreFileIterator iterator3 = storeFile2.getReader().iterator();
...
//        MergeIterator mergeIterator = new MergeIterator(Arrays.asList(storeFile.getReader().iterator(), storeFile2.getReader().iterator()));
