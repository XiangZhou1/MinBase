...
public class StoreManagerTest {
    public static TableManager TABLE_MANAGER = null;

    static {
        TABLE_MANAGER = Mockito.mock(TableManager.class);
    }

    @Test
    public void testCreate() throws Exception {
        StoreManager storeManager = new StoreManager(new File("data"), new Configuration(), TABLE_MANAGER);
        for (int i = 0; i < 100; i++) {
