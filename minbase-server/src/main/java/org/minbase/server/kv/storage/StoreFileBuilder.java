...
public class StoreFileBuilder {
    ...
    public StoreFileBuilder(long sotreFileBlockLengthLimit) {
        ...
        this.sotreFileBlockLengthLimit = sotreFileBlockLengthLimit;
    }
    ...
    public void add(KeyValue kv) {
        ...
        if (blockBuilder.length() > sotreFileBlockLengthLimit) {
            DataBlock block = blockBuilder.build();
            MetaBlock blockMeta = new MetaBlock(blockOffset, firstKey, lastKey, block.getKeyValueCount());
