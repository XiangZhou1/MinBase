...
public class TableValue {
    ...
    private static TableValue DELETE = new TableValue(TYPE_DELETE_ALL);

    public TableValue() {
    }

    public TableValue(byte type) {
        this.type = type;
    }

    private TableValue(byte type, ColumnValues columnValues) {
        this.type = type;
        this.columnValues = columnValues;
    }

    private TableValue(byte type, Set<byte[]> deletedColumns) {
        this.type = type;
        this.deletedColumns = deletedColumns;
    }

    public static TableValue Put() {
        return new TableValue(TYPE_PUT, new ColumnValues());
    }

    public static TableValue Put(ColumnValues columnValues) {
        return new TableValue(TYPE_PUT, columnValues);
    }

    public static TableValue Put(byte[] column, byte[] bytes) {
    ...
    public static TableValue Delete() {
        return DELETE;
    }

    public static TableValue DeleteColumn() {
        return new TableValue(TYPE_DELETE_COLUMN, new HashSet<>());
    }

    public static TableValue DeleteColumn(byte[]... columns) {
        Set<byte[]> deletedColumns = new HashSet<>(Arrays.asList(columns));
        return new TableValue(TYPE_DELETE_COLUMN, deletedColumns);
    }
